    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (game != "Game Time")
            {
                ...
                {
                    case "OutFall 4":
                        balance -= 39.99; if (balance >= 0) Console.WriteLine("Bought OutFall 4");
                        else if (balance < 0) { Console.WriteLine("Too Expensive"); balance += 39.99; }; break;
                    case "CS: OG":
                        balance -= 15.99; if (balance >= 0) Console.WriteLine("Bought CS: OG");
                        else if (balance < 0) { Console.WriteLine("Too Expensive"); balance += 15.99; }; break;
                    case "Zplinter Zell":
                        balance -= 19.99; if (balance >= 0) Console.WriteLine("Bought Zplinter Zell");
                        else if (balance < 0) { Console.WriteLine("Too Expensive"); balance += 19.99; }; break;
                    case "Honored 2":
                        balance -= 59.99; if (balance >= 0) Console.WriteLine("Bought Honored 2");
                        else if (balance < 0) { Console.WriteLine("Too Expensive"); balance += 59.99; }; break;
                    case "RoverWatch":
                        balance -= 29.99; if (balance >= 0) Console.WriteLine("Bought RoverWatch");
                        else if (balance < 0) { Console.WriteLine("Too Expensive"); balance += 29.99; }; break;
                    case "RoverWatch Origins Edition":
                        balance -= 39.99; if (balance >= 0) Console.WriteLine("Bought RoverWatch Origins Edition");
                        else if (balance < 0) { Console.WriteLine("Too Expensive"); balance += 39.99; }; break;
